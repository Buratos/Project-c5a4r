...
function find_parent(JQuery_object, classes_or_object) {
  switch (typeof classes_or_object) {
    case "string" :
      var parent = $(JQuery_object).parent();
      while (!parent.hasClass(classes_or_object) && parent.length) {
        parent = $(parent).parent();
      }
      break;
    case "object" :
      var parent = $(JQuery_object).parent();
      while ((!parent.hasClass(classes_or_object.classes) || !parent.is(classes_or_object.tag)) && parent.length) {
        parent = $(parent).parent();
      }
      break;
    default:
