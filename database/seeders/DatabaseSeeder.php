...
class DatabaseSeeder extends Seeder {
   ...
   public function run() {
      $this->call([UserSeeder::class, BodyTypeSeeder::class, BrandSeeder::class, CarModelSeeder::class, ColorSeeder::class, EngineTypeSeeder::class, ProductionCountrySeeder::class, TransmissionTypeSeeder::class, VehicleDriveTypeSeeder::class,TagSeeder::class, PostSeeder::class]);
