<div class="content container pt-3 pb-1">
	<div class="row car_list">
		...
		<hr>
		<form class="update_car_form" enctype="multipart/form-data" id="update_car_form">
			...
			<div class="row my-2">
				<div class="input-group">
					...
					<textarea class="form-control" cols="50" placeholder="Сюда вы можете добавить текст" rows="5" name="description" id="description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa, cumque eveniet facere facilis impedit in molestiae molestias nisi perspiciatis porro praesentium quibusdam ratione vitae voluptatum!</textarea>
				</div>
			</div>
			<div class="row my-1">
				<div class="col-12 text-center">
					<a class="btn btn-primary me-3" id="save_data" style="min-width: 7rem">Save</a>
