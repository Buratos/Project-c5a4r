	...
	<div class="row car_list">
		...
		<div class="row my-1">
			<div class="col-12 text-center">
				<a href="{{route("car.edit",["id" => $car->id])}}" class="btn btn-primary me-3" id="edit_car" style="min-width: 7rem">Edit car</a>
				<a href="{{route("car.delete",["id" => $car->id])}}" class="btn btn-primary me-3" id="delete_car" style="min-width: 7rem">Delete car</a>
			</div>
		</div>
